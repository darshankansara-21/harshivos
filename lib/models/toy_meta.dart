...
const List<ToyMeta> kToyCatalog = <ToyMeta>[
  ...
  ToyMeta(id: 'marble_run', title: 'Infinite Marble Run', emoji: '🔵', implemented: true,
      ...
      channels: [SensoryChannel.visual, SensoryChannel.proprioceptive]),
  ToyMeta(id: 'snack_studio', title: 'Pocket Picnic', emoji: '🧺', implemented: true,
      gradient: [Color(0xFF06D6A0), Color(0xFFFFD166)],
      channels: [SensoryChannel.visual, SensoryChannel.tactile]),
  ToyMeta(id: 'fruit_catch', title: 'Fruit Catch', emoji: '🧺', implemented: true,
      gradient: [Color(0xFF43E97B), Color(0xFF38F9D7)],
      channels: [SensoryChannel.visual, SensoryChannel.proprioceptive]),
  ToyMeta(id: 'balloon_pop', title: 'Balloon Pop', emoji: '🎈', implemented: true,
      gradient: [Color(0xFFEF476F), Color(0xFFFFD166)],
      channels: [SensoryChannel.visual, SensoryChannel.auditory]),
  ToyMeta(id: 'star_tap', title: 'Star Tap', emoji: '⭐', implemented: true,
      gradient: [Color(0xFFFFD166), Color(0xFFFFB88C)],
      channels: [SensoryChannel.visual]),
  ...
  ToyMeta(id: 'bowling', title: 'Bowling', emoji: '🎳', implemented: true,
      ...
      channels: [SensoryChannel.visual, SensoryChannel.proprioceptive]),
  ToyMeta(id: 'whack', title: 'Whack', emoji: '🔨', implemented: true,
      gradient: [Color(0xFF8D5A3B), Color(0xFF4A3420)],
      channels: [SensoryChannel.visual, SensoryChannel.proprioceptive]),
  ToyMeta(id: 'sky_hop', title: 'Sky Hop', emoji: '🐤', implemented: true,
      gradient: [Color(0xFF4EC5F1), Color(0xFFA8E6CF)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'stack', title: 'Stack', emoji: '🧱', implemented: true,
      gradient: [Color(0xFF4CC9F0), Color(0xFF11294B)],
      channels: [SensoryChannel.visual, SensoryChannel.proprioceptive]),
  ToyMeta(id: 'merge', title: 'Merge', emoji: '🔢', implemented: true,
      gradient: [Color(0xFFF7B801), Color(0xFF2A2036)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'echo', title: 'Echo', emoji: '🎵', implemented: true,
      gradient: [Color(0xFF9B5DE5), Color(0xFF1B1140)],
      channels: [SensoryChannel.visual, SensoryChannel.auditory]),
  ToyMeta(id: 'tictactoe', title: 'Tic-Tac-Toe', emoji: '⭕', implemented: true,
      gradient: [Color(0xFF43E97B), Color(0xFF12314A)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'brick_break', title: 'Brick Break', emoji: '🧱',
      implemented: true,
      gradient: [Color(0xFFFF6B6B), Color(0xFF20123A)],
      channels: [SensoryChannel.visual, SensoryChannel.proprioceptive]),
  ToyMeta(id: 'space_dodge', title: 'Space Dodge', emoji: '🚀',
      implemented: true,
      gradient: [Color(0xFF9B5DE5), Color(0xFF0B1030)],
      channels: [SensoryChannel.visual, SensoryChannel.vestibular]),
  ToyMeta(id: 'memory_flip', title: 'Memory Flip', emoji: '🧠',
      implemented: true,
      gradient: [Color(0xFF06D6A0), Color(0xFF10233A)],
      channels: [SensoryChannel.visual]),
];
