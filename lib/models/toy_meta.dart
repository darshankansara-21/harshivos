...
const List<ToyMeta> kToyCatalog = <ToyMeta>[
  ...
  ToyMeta(id: 'memory_flip', title: 'Memory Flip', emoji: '🧠',
      ...
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'ball_sort', title: 'Ball Sort', emoji: '🧪',
      implemented: true,
      gradient: [Color(0xFF4CC9F0), Color(0xFF0E2233)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'tap_order', title: 'Tap Order', emoji: '🔢',
      implemented: true,
      gradient: [Color(0xFF06D6A0), Color(0xFF0A1626)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'piano_tiles', title: 'Piano Tiles', emoji: '🎹',
      implemented: true,
      gradient: [Color(0xFF9B5DE5), Color(0xFF241640)],
      channels: [SensoryChannel.visual, SensoryChannel.auditory]),
  ToyMeta(id: 'block_blast', title: 'Block Blast', emoji: '🟦',
      implemented: true,
      gradient: [Color(0xFF4CC9F0), Color(0xFF0B1020)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'bubble_shooter', title: 'Bubble Shooter', emoji: '🫧',
      implemented: true,
      gradient: [Color(0xFF4CC9F0), Color(0xFF060B18)],
      channels: [SensoryChannel.visual, SensoryChannel.auditory]),
  ToyMeta(id: 'color_quest', title: 'Color Quest', emoji: '🎨',
      implemented: true,
      gradient: [Color(0xFFFFD166), Color(0xFF28205A)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'shape_scout', title: 'Shape Scout', emoji: '🔷',
      implemented: true,
      gradient: [Color(0xFF4CC9F0), Color(0xFF123A52)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'number_splash', title: 'Number Splash', emoji: '➕',
      implemented: true,
      gradient: [Color(0xFF43E97B), Color(0xFF174D3A)],
      channels: [SensoryChannel.visual]),
  ToyMeta(id: 'path_finder', title: 'Path Finder', emoji: '🗺️',
      implemented: true,
      gradient: [Color(0xFFFFD166), Color(0xFF10283A)],
      channels: [SensoryChannel.visual, SensoryChannel.proprioceptive]),
  ToyMeta(id: 'goal_keeper', title: 'Goal Keeper', emoji: '🥅',
      implemented: true,
